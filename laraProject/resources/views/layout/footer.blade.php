<div class="container">
    <div class="footer">
        <div class="columns">
            <ul class="card" style="margin-left: 12%;">
            ...
            <ul class="card" style="margin-left: 17%;">
